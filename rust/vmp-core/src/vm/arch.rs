...
impl ArchConfig {
    ...
    pub fn new_random() -> Self {
        ...
        // VJcc 有 16 个条件变体，每个需要独立的 handler（因为 cmov 指令编码不同）
        let core_ops = vec![
            ...
            // 16 VJcc 条件变体
            VmOpcode::VJcc(0, 0), VmOpcode::VJcc(1, 0), VmOpcode::VJcc(2, 0), VmOpcode::VJcc(3, 0),
            VmOpcode::VJcc(4, 0), VmOpcode::VJcc(5, 0), VmOpcode::VJcc(6, 0), VmOpcode::VJcc(7, 0),
            VmOpcode::VJcc(8, 0), VmOpcode::VJcc(9, 0), VmOpcode::VJcc(10, 0), VmOpcode::VJcc(11, 0),
            VmOpcode::VJcc(12, 0), VmOpcode::VJcc(13, 0), VmOpcode::VJcc(14, 0), VmOpcode::VJcc(15, 0),
        ];
