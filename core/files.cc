...
// BaseResource, BaseResourceList -> files/resources.cc
...
// BaseRuntimeFunction, BaseRuntimeFunctionList -> files/runtime_func.cc
...
// CompilerFunction, CompilerFunctionList -> files/compiler_func.cc
...
// MarkerCommand, MarkerCommandList -> files/markers.cc
...
// MemoryRegion, MemoryManager, CRCTable -> files/memory.cc
...
// Memory classes -> files/memory.cc

// CRCInfo constructor -> files/memory.cc